...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyUALife.DateChangeListener, MyUALife, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", DateChangeListener.class, __md_methods);
	}


	public DateChangeListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == DateChangeListener.class)
			mono.android.TypeManager.Activate ("MyUALife.DateChangeListener, MyUALife, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
